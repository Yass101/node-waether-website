...
const forecast = (latitude, longitude, callback) => {
    ...
    request({
        ...
        if (error) {
            ...
            callback(undefined, `It's is currently ${response.body.currently.temperature} degrees out. There is a ${response.body.currently.precipIntensity}% chance of rain`)
        }
    })
}
